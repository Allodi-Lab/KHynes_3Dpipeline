...
input_folder = r"D:\Conn_3dpipeline\raw_converted_C00"
output_folder = r"D:\Conn_3dpipeline\raw_converted_C00_converted"
...
for i, filename in enumerate(files):
    ...
    try:
        ...
        print(f"Failed {i+1}/{len(files)}: {filename} — {e}")
